ACT_KIRBY_WALKING = allocate_mario_action(ACT_GROUP_STATIONARY | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
-- ACT_KIRBY_HOLD_WALKING = allocate_mario_action()
